...
class RNNs{
    ...
    void backward(vector<double> X, double Y){
        ...
        /*
         ...
         ----  = ------- x -------- x -------- = (hat_Y-Y) * (1-tanh(net_Y)) * (1+tanh(net_Y))*H
         a(Wy)   a(hat_Y)  a(net_Y)   a(Wy)

         aL      aL        a(hat_Y)   a(net_Y)
         ----  = ------- x -------- x -------- = (hat_Y-Y) * (1-tanh(net_Y)) * (1+tanh(net_Y))*1
         a(By)   a(hat_Y)  a(net_Y)   a(By)

         2)BPTT
         aL      aL         a(hat_Y)   a(net_Y)   aH         a(net_H)
         ----  = -------- x -------- x -------- x -------- x -------- + ...... = (hat_Y-Y) * (1-tanh(net_Y)) * (1+tanh(net_Y)) * Wy * (1-tanh(net_H)) * (1+tanh(net_H)) * X + .... 
         a(Wx)   a(hat_Y)   a(net_Y)   aH         a(net_H)   a(Wx)

         aL      aL         a(hat_Y)   a(net_Y)   aH         a(net_H)
         ----  = -------- x -------- x -------- x -------- x -------- + ...... = (hat_Y-Y) * (1-tanh(net_Y)) * (1+tanh(net_Y)) * Wy * (1-tanh(net_H)) * (1+tanh(net_H)) * 1 + .... 
         a(Bx)   a(hat_Y)   a(net_Y)   aH         a(net_H)   a(Bx)

         3)BPTT
         aL      aL         a(hat_Y)   a(net_Y)   aH         a(net_H)
         ---- =  -------- x -------- x -------- x -------- x -------- + ...... = (hat_Y-Y) * (1-tanh(net_Y)) * (1+tanh(net_Y)) * Wy * (1-tanh(net_H)) * (1+tanh(net_H)) * prev_H + .... 
         a(Wh)   a(hat_Y)   a(net_Y)   aH         a(net_H)   a(Wh)
        */
       vector<double> prev_H = H;
       double net_H[nUnits] = {0,};
       double out_H[nUnits] = {0,};
       ...
       1)        
         ...
         a(By)   a(hat_Y)  a(net_Y)   a(By)
       */
       double aL_aWy[nUnits] = {0,}, aL_aBy = 0;
      ...
      double aL_aWx[nStates][nUnits] = {0,}, aL_aBx[nUnits] = {0,};
